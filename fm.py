...
class fm(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.channel_freq = channel_freq = 100.9e6
        ...
        # Blocks
        ##################################################
        self._channel_freq_range = Range(88e6, 108e6, 0.1e6, 100.9e6, 200)
        self._channel_freq_win = RangeWidget(self._channel_freq_range, self.set_channel_freq, 'Freq', "counter_slider", float)
        self.top_grid_layout.addWidget(self._channel_freq_win)
        self._audio_gain_range = Range(0, 2, 0.1, 0.5, 20)
        self._audio_gain_win = RangeWidget(self._audio_gain_range, self.set_audio_gain, 'Volume', "counter_slider", float)
